...
export default function Prospects() {
  ...
  async function load() {
    ...
    const { data: prospects } = await api.get('/prospects', {
      params: { search, tier, status, archived, pageSize: 100 }
    });
  ...
  useEffect(() => { load(); }, [search, tier, status, archived]);
  ...
  async function handleCreate(e) {
    ...
    try {
      ...
      showStatus(
        "success",
        "Prospect Created",
        "New prospect has been added successfully."
      );
      ...
      showStatus(
        "error",
        "Create Failed",
        err.response?.data?.error || "Unable to create prospect."
      );
    }
  }
  ...
  async function handleEditSave(e) {
    ...
    try {
      ...
      showStatus(
        "error",
        "Update Failed",
        err.response?.data?.error || "Unable to update prospect."
      );
    }
  }
  ...
  async function handleDelete(row) {
    ...
    try {
      ...
      showStatus(
        "error",
        "Delete Failed",
        err.response?.data?.error || "Unable to delete prospect."
      );
    }
  }
  ...
  async function handleAssign() {
    ...
    try {
      ...
      showStatus(
        "success",
        "Caller Assigned",
        "Prospect assigned successfully."
      );
      ...
      showStatus(
        "error",
        "Assignment Failed",
        err.response?.data?.error || "Unable to assign caller."
      );
    }
  }
