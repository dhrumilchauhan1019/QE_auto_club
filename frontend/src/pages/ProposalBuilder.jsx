...
export default function ProposalBuilder() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      showStatus(
        "success",
        "Proposal Generated",
        "Proposal has been generated successfully."
      );
      ...
      showStatus(
        "error",
        "Generation Failed",
        err.response?.data?.error || "Unable to generate proposal."
      );
  ...
  async function markAccepted() {
    ...
    try {
      ...
      await api.patch(
        `/proposals/${summary.proposal.id}/status`,
        {
          status: "accepted",
        }
      );
      ...
      showStatus(
        "success",
        "Proposal Accepted",
        "Proposal has been marked as accepted."
      );
      ...
      showStatus(
        "error",
        "Update Failed",
        err.response?.data?.error || "Unable to update proposal status."
      );
